...
... or download the [source file](https://github.com/mytalbot/tiefightR/blob/master/tiefightR_0.0.0.9000.tar.gz) for easy installation from within R (or RStudio) if you don't have devtools available.
