...
... or download the [source file](https://github.com/mytalbot/tiefightR/tree/master/sourcefiles) for easy installation from within R (or RStudio) if you don't have devtools available.
